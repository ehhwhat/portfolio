...
import Data from './assets/data/DataCaseMerchantCantos'

function AppCaseMerchantCantos() {
    return (
        <div className="App">
            <main className={'bg-light'}>
                <div className={'container'}>
                    ...
                    <TextImage
                        ...
                        overlay={true}
                        altLayout={Data[0].detailed ? false : true}
                        content={<div>
                    ...
                    />
                    <section className="row section-row justify-content-center mt-5">
...
export default AppCaseMerchantCantos;
