...
import Data from './assets/data/DataCaseICAEW2'

function AppCaseICAEW2() {
    return (
        <div className="App">
                    ...
                    <TextImage
                        ...
                        content={<div>
                            ...
                            <ul>
                                ...
                                {Data[0].other.link2 ? <li><a href={Data[0].other.link2.url}>{Data[0].other.link2.text}</a></li> : ''}
                            </ul>
                        </div>}
                    />
